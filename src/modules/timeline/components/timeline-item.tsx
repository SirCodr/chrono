...
import type { Record, RecordUpdate, SyncStatus } from '@/types/record'
import {
  AlertDialogHeader,
  AlertDialogFooter,
...
function getSyncStatus(record: Record): SyncStatus | null {
  if (record.syncPending) return 'pending'
  if (record.googleCalendarEventId) return 'synced'
  return null
}
  ...
  return (
    <>
      <Card className='relative'>
            ...
            <div className='space-y-1'>
              ...
              <CardDescription className='flex items-center gap-2 flex-wrap'>
                ...
                {(() => {
                  ...
                  return status ? <GoogleCalendarSync status={status} /> : null
                })()}
              </CardDescription>
            </div>
            <DropdownMenu>
        ...
        <CardContent>
          {!record.isAutoGenerated && record.description && (
          ...
          {record.isAutoGenerated && (
            <p className='text-sm text-muted-foreground/50 italic mb-3'>
              Contenido autogenerado por Google Calendar (oculto)
            </p>
          )}
        </CardContent>
      </Card>
